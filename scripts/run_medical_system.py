...
with open(os.path.join(_DATA_DIR, "svc.pkl"), "rb") as f:
    svc = pickle.load(f)
print("Loading medical databases...")
sym_des = pd.read_csv(os.path.join(_DATA_DIR, "symtoms_df.csv"))
precautions = pd.read_csv(os.path.join(_DATA_DIR, "precautions_df.csv"))
workout = pd.read_csv(os.path.join(_DATA_DIR, "workout_df.csv"))
description = pd.read_csv(os.path.join(_DATA_DIR, "description.csv"))
medications = pd.read_csv(os.path.join(_DATA_DIR, "medications.csv"))
diets = pd.read_csv(os.path.join(_DATA_DIR, "diets.csv"))
